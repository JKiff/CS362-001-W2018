...
public class TimeTableTest {
	 ...
	 @Test
	  public void test01()  throws Throwable  {
		 ...
		 // assertEquals(tt.getApptRange(appts, day1, day).size(), 0);

		 tt.deleteAppt(appts, appt1);
		 tt.deleteAppt(null, null);
		 tt.deleteAppt(appts, null);
		 tt.deleteAppt(appts, appt3);
		 assertEquals(null, tt.deleteAppt(null, appt0));
		 // assertEquals(appt3, tt.deleteAppt(appts, appt3));
		 assertEquals(null, tt.deleteAppt(appts, null));
		 assertEquals(null, tt.deleteAppt(appts, appt6));
		 // assertEquals(appts, tt.deleteAppt(appts, appt0));
